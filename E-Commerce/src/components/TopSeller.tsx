...
const TopSeller = () => {
  ...
  useEffect(() => {
    ...
    return <div className="bg-white p-5 mx-5 mt-20 border w-[23rem] rounded">
        <h2 className="text-xl font-bold mb-5">TopSeller</h2>
        <ul>
            {authors.map((author, index) => (<li key={index} className="flex items-center justify-between mb-4">
