...
const MainContent = () => {
  ...
  return (
    <section className="xl:w-[55rem] mr-[10rem] lg:w-[55rem] sm:w-[40rem] xs:w-[20rem] p-5">
      <div className="mb-5">
        <div className="flex flex-col sm:felx-row justify-between ">
          <div className="relative mb-5 mt-5">
            ...
            {dropdownOpen && (
              <div className="absolute bg-white border border-gray-100 rounded mt-2 w-full sm:w-40 ">
                <button
        ...
        <div className="grid grid-cols-4 sm:grid-cols- md:grid-cols-4 gap-5">
          {/*BookCard */}
